...
# 下载所需文件到系统
wget -q --no-check-certificate https://gh-proxy.com/https://raw.githubusercontent.com/newday-life/jellyfin-crx/master/static/css/style.css -O style.css  
wget -q --no-check-certificate https://gh-proxy.com/https://raw.githubusercontent.com/newday-life/jellyfin-crx/master/static/js/common-utils.js -O common-utils.js  
wget -q --no-check-certificate https://gh-proxy.com/https://raw.githubusercontent.com/newday-life/jellyfin-crx/master/static/js/jquery-3.6.0.min.js -O jquery-3.6.0.min.js  
wget -q --no-check-certificate https://gh-proxy.com/https://raw.githubusercontent.com/newday-life/jellyfin-crx/master/static/js/md5.min.js -O md5.min.js  
wget -q --no-check-certificate https://gh-proxy.com/https://raw.githubusercontent.com/newday-life/jellyfin-crx/master/content/main.js -O main.js
echo "已下载缓存文件！"
